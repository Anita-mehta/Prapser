...
public class LaywerConsultFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_laywer_consult, container, false);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.iv_filters_et:
                Navigation.findNavController(view).navigate(R.id.action_laywerConsultFragment_to_filtersFragment);
                break;
