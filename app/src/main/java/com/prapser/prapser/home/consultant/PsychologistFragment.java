...
public class PsychologistFragment extends Fragment implements View.OnClickListener {
  ...
  private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_psychologist, container, false);
    ...
    private void findId() {
        iv_filters = view.findViewById(R.id.iv_filters);
        ...
        iv_filters.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_filters:
                Navigation.findNavController(view).navigate(R.id.action_psychologistFragment_to_filtersFragment);
                break;
        }
