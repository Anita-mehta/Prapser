...
public class DoctorConsultFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        findID();
        loadFragment(new DoctorOfficeFragment());
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.online_consult:
                ...
                loadFragment(new DoctorOnlineConsultFragment());
                break;
            ...
            case R.id.iv_filters_et:
                Navigation.findNavController(view).navigate(R.id.action_doctorConsultFragment_to_filtersFragment);
                break;
