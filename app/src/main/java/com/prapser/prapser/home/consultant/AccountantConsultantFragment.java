...
public class AccountantConsultantFragment extends Fragment implements View.OnClickListener {
   ...
   private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_accountant_consultant, container, false);
        findId();
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.iv_filters_et:
                Navigation.findNavController(view).navigate(R.id.action_accountantConsultantFragment_to_filtersFragment);
                break;
