...
public class PlumberFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.iv_filters_et:
                Navigation.findNavController(view).navigate(R.id.action_plumberFragment_to_filtersFragment);
        }
